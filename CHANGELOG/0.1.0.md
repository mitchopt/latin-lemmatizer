...
- `src/latin_lemmatizer/` package with CLI (Typer + Rich), py.typed marker
...
[@mitchopt](https://github.com/mitchopt) (Mitchell G. Harris) created Latin Lemmatizer.
